...
class mail_queueModel extends Model
{
     ...
     * test
     * */
    public function sendTest($limit = 5) {
    	//发送
    	$mailer = mailer::get_instance();
    	dump($mailer);
    	$_mail['mail_to'] = 'jimyan@i-lz.cn';
    	$_mail['mail_subject'] = 'testSunbject';
    	$_mail['mail_body'] = 'testBody';
    	return $mailer->send($_mail['mail_to'], $_mail['mail_subject'], $_mail['mail_body']);
