...
class userModel extends RelationModel
{
    protected $_validate = array(
        ...
        array('password', '6,100', '{%password_length_error}', 0, 'length', 1), //密码长度
    ...
    public function queryBindStatus($uid){
		 $result = $this->field('card_num,bindstatus')->where('id=' . $uid) -> find();
		 /* if ($result ==1 ){ //绑定
