(function (a) {
    function u(j, b) {
        ...
        function m(a) {
            ...
            j += '<div class="dw-li dw-v" data-val="' + b + '" style="height:' + M + "px;line-height:" + M + 'px;"><div class="dw-i">' + $[a][b] + "</div></div>",
            c++;
            return j + "</div>"
        }
        function q(j) {
        ...
        function o(j, c, b, f, i) {
            !1 !== N("validate", [z, c, j]) && (a(".dw-ul", z).each(function (b) {
                ...
                if (!e.hasClass("dw-v")) {
                        ...
                        I = h.eq(g - m);
                        for (; g + q < p && !e.hasClass("dw-v");) q++,
                        e = h.eq(g + q);
                        (q < m && q && 2 !== f || !m || 0 > g - m || 1 == f) && e.hasClass("dw-v") ? g += q : (e = I, g -= m)
                    }
                if (!e.hasClass("dw-sel") || l) n.temp[b] = e.attr("data-val"),
                a(".dw-sel", d).removeClass("dw-sel"),
                e.addClass("dw-sel"),
                n.scroll(d, b, g, l ? j : 0.1, l ? i : void 0)
            }), n.change(b))
        }
        function u(j) {
            if (!("inline" == p.display || S === a(window).width() && ca === a(window).height() && j)) {
                ...
                V = I.outerWidth();
                P = I.outerHeight(!0);
                "modal" == p.display ? (b = (S - V) / 2, e = j + (O - P) / 2) : "bubble" == p.display ? (m = !0, h = a(".dw-arrw-i", z), b = f.offset(), i = b.top, g = b.left, d = f.outerWidth(), f = f.outerHeight(), b = g - (I.outerWidth(!0) - d) / 2, b = b > S - V ? S - (V + 20) : b, b = 0 <= b ? b : 20, e = i - P, e < j || i > j + O ? (I.removeClass("dw-bubble-top").addClass("dw-bubble-bottom"), e = i + f) : I.removeClass("dw-bubble-bottom").addClass("dw-bubble-top"), h = h.outerWidth(), d = g + d / 2 - (b + (V - h) / 2), a(".dw-arr", z).css({
                        left: d > h ? h : d
        ...
        n.show = function (j) {
                ...
                for (var d = '<div class="dw-trans ' + p.theme + " dw-" + p.display + '">' + ("inline" == p.display ? '<div class="dw dwbg dwi"><div class="dwwr">' : '<div class="dw-persp"><div class="dwo"></div><div class="dw dwbg ' + f + '"><div class="dw-arrw"><div class="dw-arrw-i"><div class="dw-arr"></div></div></div><div class="dwwr">' + (p.headerText ? '<div class="dwv"></div>' : "")), j = 0; j < p.wheels.length; j++) {
                        ...
                        d += '<td><div class="dwwl dwrc dwwl' + b + '">' + ("scroller" != p.mode ? '<div class="dwwb dwwbp" style="height:' + M + "px;line-height:" + M + 'px;"><span>+</span></div><div class="dwwb dwwbm" style="height:' + M + "px;line-height:" + M + 'px;"><span>&ndash;</span></div>' : "") + '<div class="dwl">' + e + '</div><div class="dww" style="height:' + p.rows * M + "px;min-width:" + p.width + 'px;"><div class="dw-ul">',
                        d += m(b),
        ...
        n.init = function (a) {
                ...
                n.settings = p;
                G.unbind(".dw");
                if (a = da.presets[p.preset]) aa = a.call(R, n),
                H(p, aa, b),
                H(ba, aa.methods);
...
(function (a) {
        ...
        B = function (k) {
            ...
            if (v.match(/date/i)) {
                    ...
                    for (i = 0; 3 > i; i++) if (i == q.y) {
                        ...
                        s++;
                        g[f.monthText] = {};
                        for (h = 0; 12 > h; h++) J = B.replace(/[dy]/gi, "").replace(/mm/, 9 > h ? "0" + (h + 1) : h + 1).replace(/m/, h + 1),
            ...
            if (v.match(/time/i)) {
                    ...
                    for (i = s; i < s + 4; i++) if (i == q.h) {
                        ...
                        s++;
                        g[f.minuteText] = {};
                        for (h = 0; 60 > h; h += e) g[f.minuteText][h] = w.match(/ii/) && 10 > h ? "0" + h : h
                    } else if (i == q.s) {
                        s++;
                        g[f.secText] = {};
    ...
    u.formatDate = function (k, t, l) {
            ...
            var l = a.extend({}, o, l),
                m = function (a) {
                    for (var g = 0; r + 1 < k.length && k.charAt(r + 1) == a;) g++,
                    r++;
                    return g
                },
                g = function (a, g, f) {
    ...
    u.parseDate = function (k, t, l) {
            ...
            var t = "object" == typeof t ? t.toString() : t + "",
                ...
                E = function (a, g, f) {
                    a = B(a) ? f : g;
                    for (g = 0; g < a.length; g++) if (t.substr(w, a[g].length).toLowerCase() == a[g].toLowerCase()) return w += a[g].length,
                    g + 1;
                    return 0
                },
                w = 0,
            ...
            if (-1 < f) {
                    ...
                    i = f;
                    do {
                        g = 32 - (new Date(l, r - 1, 32)).getDate();
                        if (i <= g) break;
                        r++;
                        i -= g
                    } while (1)
    ...
    a.mobiscroll.presets.select = function (k) {
        ...
        function U(a, b) {
            ...
            if (g) {
                var d = [],
                    f = 0;
                for (f in k._selectedValues) d.push(E[f]),
                e.push(f);
                D.val(d.join(", "))
            } else D.val(a),
            e = b ? o(k.values[y]) : null;
        ...
        var q = a('label[for="' + C + '"]'),
            h = void 0 !== l.label ? l.label : q.length ? q.text() : m.attr("name"),
            A = [],
            v = [],
            E = {},
            w, y, K, D, F = t.readonly;
